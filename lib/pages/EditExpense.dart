...
class EditExpsense extends StatefulWidget {
  var id,incomeId,expnseTypeId,amountCurrencyFormat,amount,description,dateFormat,date;

  EditExpsense({this.id,this.incomeId,this.expnseTypeId,this.amount,this.amountCurrencyFormat,this.description,this.date,this.dateFormat});

  @override
  _EditExpsenseState createState() => _EditExpsenseState();
}

class _EditExpsenseState extends State<EditExpsense> {
  //controller
  ...
  bool requiredAmount = true, requiredDate = true,requiredExpenseType=true;
  ...
  @override
  void initState() {
    ControllerAmount.text=widget.amountCurrencyFormat;
    expenseBloc.expenseAmount.sink.add(widget.amount);
    ControllerDate.text=widget.dateFormat;
    expenseBloc.dateExpense.sink.add(widget.date);
    ControllerDescription.text=widget.description;
    expenseBloc.expenseDescription.sink.add(widget.description);
    expenseBloc.expenseTypeId.sink.add(widget.expnseTypeId);
    expenseBloc.expenseId.sink.add(widget.id);
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      expenseBloc.updateExpense(context);
                    },
