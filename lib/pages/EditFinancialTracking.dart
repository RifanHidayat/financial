...
class EditFinancialTracking extends StatefulWidget {
  var id,startDateFormat,startDate,endDateFormat,endDate,amountCurrencyFormat,amount;
  EditFinancialTracking({
    ...
    this.endDate,
    this.amount,
    this.amountCurrencyFormat
});
  @override
  _EditFinancialTrackingState createState() => _EditFinancialTrackingState();
}

class _EditFinancialTrackingState extends State<EditFinancialTracking> {
  var ControllerDate = new TextEditingController();
  var ControllerAmount = new TextEditingController();

  bool _search = true;
  bool requiredAmount = true, requiredDate = true;
  ...
  void initState() {
    ...
    ControllerDate.text="${widget.startDateFormat} - ${widget.endDateFormat}";
    incomeBloc.startDateIncome.sink
        .add(widget.startDate.toString());
    incomeBloc.endDateIncome.sink
        .add(widget.endDate.toString());
    incomeBloc.incomeId.sink.add(widget.id.toString());
    incomeBloc.incomeAmount.sink.add(widget.amount);
                ...
                RaisedButton(
                  ...
                  onPressed: () {
                    if ((requiredAmount != false) && (requiredDate != false)) {
                      incomeBloc.updateIncome(context);
                    }
                  },
                ),
              )
